...
//    //NaveenV=> optionsBuilder.UseSqlServer("Server=NAVEENV\\SQL2016;Database=SAMPLETEST;User Id=sa;Password=reladmin@123;MultipleActiveResultSets=true;TrustServerCertificate=True;");
...
//    //=>optionsBuilder.UseSqlServer("Server=D465PTN3;Database=UHSB_GUIDEUAT;Trusted_Connection=True;TrustServerCertificate=True;");
//    /*UHSB*/// => optionsBuilder.UseSqlServer("Server=14.139.27.154;Database=UHSB_GUIDEUAT;User Id=UHSBGUIDE;Password=admin@123;TrustServerCertificate=True;");
